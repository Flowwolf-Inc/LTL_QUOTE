...
PICKUP_CONNECTORS = {CONNECTOR_DAYTON, CONNECTOR_TFORCE, CONNECTOR_ARCBEST, CONNECTOR_SMC3}
TRACKING_CONNECTORS = {CONNECTOR_DAYTON, CONNECTOR_TFORCE, CONNECTOR_ARCBEST, CONNECTOR_SMC3}
